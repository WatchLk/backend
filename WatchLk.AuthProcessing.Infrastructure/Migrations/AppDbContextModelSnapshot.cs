...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WatchLk.AuthProcessing.Domains.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WatchLk.AuthProcessing.Domains.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WatchLk.AuthProcessing.Domains.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WatchLk.AuthProcessing.Domains.Models.Address", b =>
                {
                    b.HasOne("WatchLk.AuthProcessing.Domains.Models.User", "User")
                        .WithMany("Addresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
