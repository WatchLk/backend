...
namespace WatchLk.ProductProcessing.Api.Endpoints
{
    public static class ProductEndpoints
    {
        ...
        public static RouteGroupBuilder MapProductEndpoints(this WebApplication app)
        {
            ...
            var group = app.MapGroup("api/Product").WithParameterValidation(); // Need to use minimal api extension package
            ...
            group.MapPost("/", async ([FromBody] CreateProductDto createProductDto, IProductRepository productRepository) =>
            {
                try
                {
            ...
            group.MapPut("/{id}", async (int id,[FromBody] UpdateProductDto updatedProductDto, IProductRepository productRepository) =>
            {
                try
                {
